    ...
    <div className="h-[300vh] container">
      <div className="flex flex-col-reverse md:flex-row items-center justify-between ">
        <motion.div initial={{opacity:0,x:-10}} animate={{opacity:1,x:0}} className="flex flex-1 gap-4 flex-col items-start">
          <h1 className="md:text-6xl text-4xl text-center md:text-left font-extrabold text-gray-700 uppercase">Welcome to Your Cactus Haven!</h1>
          <h3 className="md:text-2xl text-xl font-bold text-center md:text-left uppercase text-gray-700">Explore and Discover a Prickly Paradise of Unique Cacti</h3>
